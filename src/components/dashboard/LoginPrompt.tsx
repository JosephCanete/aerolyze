  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
            Get detailed insights into your running, cycling, and other activities. 
            Track your progress, analyze your performance, and discover patterns in your training.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Activity Analytics</h3>
              <p className="text-gray-600">
                Deep dive into your performance metrics with beautiful charts and insights.
              </p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Monitor your improvements over time and celebrate your achievements.
              </p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Browse and organize your activity photos in a beautiful interface.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-8">Trusted by athletes worldwide</p>
          <div className="flex items-center justify-center space-x-8 opacity-60">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-gray-600">Real-time Sync</span>
            </div>
            <div className="flex items-center space-x-2">
